    ...
    <>
      <div>
        <div className="final-booking-confirmation-panel">
          <div className="final-info-outline">
            <div className="final-info-image-container">
              <img src={infoSVG} alt="" className="info-image" />
            </div>
            <div className="final-info-content">
              {/* The success or error message should be replaced here(instead of hardcoding) based on the booking status */}
        ...
        <div className="final-booking-content">
          <div className="final-booking-details-container">
            <div className="final-booking-details">
              <div id="final-content">
                <FaHotel className="final-hotel-room-image" />
              </div>
          ...
          <div className="final-hotel-details-container">
            ...
            <div className="ml-28 mt-1 flex text-sm font-bold">
              <div className="text-orange-400">Check In from 01:00 PM</div>
              <div className="final-check-out-time">
